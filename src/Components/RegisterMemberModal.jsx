      ...
      >
        ...
        <div className="flex justify-center mb-6">
          <img
            ...
            className="w-32 h-32 rounded-md shadow-md border border-black"
          />
        </div>
        ...
        <Form.Item
          name="membershipNo"
          label={<span className="font-medium text-black">Membership Number</span>}
          rules={[{ required: true, message: "Please enter the membership number!" }]}
        >
          <Input
        ...
        <Form.Item
          name="registeredDate"
          label={<span className="font-medium text-black">Registered Date</span>}
        ...
        <Form.Item
          name="address"
          label={<span className="font-medium text-black">Address</span>}
        ...
        <Form.Item
          name="nic"
          label={<span className="font-medium text-black">NIC Number</span>}
        ...
        <Form.Item
          name="phoneNumber"
          label={<span className="font-medium text-black">Phone Number</span>}
          rules={[
